...
const InformationSection = () => {
  return (
    <Box p={8} bg="gray.50" shadow=' rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px'>
      <VStack spacing={8} align="start">
        ...
        <Box>
          ...
          <Text mt={2}>
            Customer centricity is the core of our values. Our team of highly trained and experienced doctors, phlebotomists, and pharmacists look into each order to give you a fulfilling experience.
          </Text>
          <Text mt={2}>
            We’ve made healthcare accessible to millions by giving them quality care at affordable prices. Customer centricity is the core of our values. Our team of highly trained and experienced doctors, phlebotomists, and pharmacists look into each order to give you a fulfilling experience.
          </Text>
          <Text mt={2}>
            Visit our online medical store now, and avail online medicine purchase at a discount. Stay Healthy!
          </Text>
        </Box>
      </VStack>
    </Box>
